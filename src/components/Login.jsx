...
const Login = (props) => {
  ...
  const { getUser, verifyCaptcha } = context;
  ...
  return (
    <div id="login">
      <div className="flex flex-col lg:flex-row shadow-lg mb-1">
            ...
            <div className="px-4">
              ...
              <div className="flex gap-6 mb-4">
                <div className="flex items-center gap-2">
                  <i className="fa-solid fa-pills fa-lg"></i>
                  <p>Supplements</p>
                </div>
                <div className="flex items-center gap-2">
                  <i className="fa-solid fa-star-of-life fa-lg"></i>
                  <p>Health care</p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full p-6 md:p-10">
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                Sign In
                {loader && (
                  <span className="ml-2 animate-spin border-2 border-t-transparent border-white rounded-full w-4 h-4"></span>
                )}
              </button>
