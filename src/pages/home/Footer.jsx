      ...
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-6 gap-8">
        ...
        {!localStorage.getItem("token") ? (
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/account?details" className="hover:text-white">
                  Account
                </a>
              </li>
            </ul>
        ...
        <div>
          ...
          <div className="flex space-x-4 text-lg">
            <a href="#" className="hover:text-white">
              <i className="bi bi-twitter"></i>T
            </a>
            <a href="#" className="hover:text-white">
              <i className="bi bi-facebook"></i>F
            </a>
            <a href="#" className="hover:text-white">
              <i className="bi bi-github"></i>G
            </a>
            <a href="#" className="hover:text-white">
              <i className="bi bi-linkedin"></i>L
            </a>
          </div>
        </div>
      </div>
